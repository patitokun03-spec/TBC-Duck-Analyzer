...
const ENCHANT_DB = {
    ...
    // Enchants
    2670: { name: "Major Agility (+35 Agility)", icon: "inv_stone_weightstone_07" },
    3001: { name: "Glyph of Renewal (+35 H, +12 SP, 7 MP5)" },
    2980: { name: "Gr. Inscription of Faith (+33 H, +11 SP, 4 MP5)" },
    2746: { name: "Golden Spellthread (+66 H, +22 SP, +20 Stam)" },
    2940: { name: "Boar's Speed (+9 Stam, Minor Speed)" },
    2617: { name: "Superior Healing (+30 H, +10 SP)" },
    3003: { name: "Glyph of Ferocity (+34 AP & 16 Hit)" },
    2986: { name: "Gr. Inscr. of the Blade (+30 Attack Power & 10 Crit)" },
    3012: { name: "Nethercobra Leg Armor (+50 Attack Power & 12 Crit)" },
    2657: { name: "Dexterity (+12 Agility)" },
    368: { name: "Greater Agility (+12 Agility)" },
    2647: { name: "Brawn (+12 Strength)" },
    684: { name: "Major Strength (+15 Strength)" },
    2673: { name: "Mongoose" },
    1900: { name: "Crusader" },
    2661: { name: "Exceptional Stats (+6 All Stats)" },
    33990: { name: "Major Spirit (+15 Spirit)" },
    2991: { name: "Glyph of the Defender (+15 Defense & +10 Dodge)" },
    3002: { name: "Glyph of Power (+22 Spell Power & +14 Hit)" },
    2748: { name: "Runic Spellthread (+35 Spell Power & 20 Stamina)" },
    2646: { name: "Fortitude (+12 Stamina)" },
    2650: { name: "Spellpower (+15 Spell Power)" },
    2937: { name: "Spellpower (+20 Spell Power)" },
    2928: { name: "Spellpower (+12 Spell Power)" },
    2668: { name: "Vitality (+20 Spell Power & Healing)" },
    1071: { name: "Stamina (+18 Stamina)" },
    2343: { name: "Healing Power (+81 Healing & +27 Spell Power)" },
    2654: { name: "Intellect (+12 Intellect)" },
    2982: { name: "Gr. Inscr. of the Orb (+18 Spell Power & 10 Crit)" },
    2614: { name: "Shadowpower (+20 Shadow Spell Power)" },
    2621: { name: "Subtlety" },
    2672: { name: "Soulfrost" },
    2564: { name: "Major Agility (+16 Agility)" },
    1583: { name: "Superior Striking (+24 Attack Power)" },
    2669: { name: "Major Spellpower (+40 Spell Power)" },
    2997: { name: "Inscription of Vengeance (+20 Attack Power & 15 Crit)" },
    2995: { name: "Inscription of Discipline (+12 Spell Power & 15 Crit)" },
    2662: { name: "Major Armor (+120 Armor)" },
    2622: { name: "Dodge (+12 Dodge)" },
    2979: { name: "Superior Healing (+29 Healing & 10 Spell Power)" },
    3150: { name: "Restore Mana Prime (+6 MP5)" },
    2930: { name: "Healing Power (+20 Healing & 7 Spell Power)" },
    2983: { name: "Assault (+26 Attack Power)" },
    1593: { name: "Assault (+24 Attack Power)" },
    1594: { name: "Striking (+26 Attack Power)" },
    2649: { name: "Fortitude (+12 Stamina)" },
    2322: { name: "Major Healing (+35 Healing & 12 Spell Power)" },
    3010: { name: "Cobra Hide Leg Armor (+40 Attack Power & +10 Crit)" },
    3011: { name: "Clefthide Leg Armor (+40 Attack Power & +10 Crit)" },
    2504: { name: "Spell Power (+30 Spell Power)" },
    369: { name: "Major Intellect (+12 Intellect)" },
    2981: { name: "Inscription of Discipline (+15 Spell Power)" },
    1891: { name: "Greater Stats (+4 All Stats)" },
    2938: { name: "Spell Penetration (+20 Spell Penetration)" },
    ...
    2990: { name: "Inscription of the Knight (+13 Defense)" },
    2939: { name: "Cat Swiftness (+6 Agility, Minor Speed)" },
};
